...
function LikeCounter({ color, title, description, count = 0 }) {
    ...
    useEffect(() => {
        ...
        // jak dodac do tego że jak jest powyżej 20 likow to jest inny tekst
        if (likes > 20) {
            document.title = `Wow! More than 20 likes: ${likes}`;
        }
